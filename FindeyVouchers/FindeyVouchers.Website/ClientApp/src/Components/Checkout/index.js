...
class CheckoutForm extends React.Component {
    ...
    handleSubmit = async (event) => {
        ...
        const {stripe, elements, ideal, cartTotal} = this.props;
...
const
    Checkout = (props) => {
        ...
        const toggleIDEAL = () => {
            setIsOpenIDEAL(!isOpenIDEAL);
            setIsOpenBANK(isOpenIDEAL);
        };
        const [isOpenBANK, setIsOpenBANK] = useState(false);
        const toggleBANK = () => {
            setIsOpenBANK(!isOpenBANK);
            setIsOpenIDEAL(isOpenBANK);
        };
                            ...
                            <ToastBody>
                                <ListGroup>
                                    ...
                                    <ListGroupItem className="fixed-bottom">Totaal: <span
                                        className="float-right font-weight-bold">€ {props.cartTotal}</span></ListGroupItem>
                                </ListGroup>
                            </ToastBody>
                        </Toast>
                    </Col>
                    <Col sm="12" md="7" className="justify-content-center">
                        ...
                        <Row>
                            <Toast className="mci-toast">
                                ...
                                <ToastBody>
                                    <Col sm="12" md="6" className="d-inline-block">
                                        <Button className="mci-checkout-button" color="primary" onClick={toggleIDEAL}
                                                style={{marginBottom: '1rem'}}>IDEAL</Button>
                                    </Col>
                                    <Col sm="12" md="6" className="d-inline-block">
                                        <Button className="mci-checkout-button" color="primary" onClick={toggleBANK}
                                        ...
                                        <Card>
                                            <CardBody>
                                                <Elements stripe={stripePromise}>
                                                    <InjectedCheckoutForm cartItems={props.cartItems}
                                                                          cartTotal={props.cartTotal} ideal={true}/>
                                                </Elements>
                                            </CardBody>
                                        </Card>
                                    </Collapse>
                                    <Collapse isOpen={isOpenBANK}>
                                        <Card>
                                            <CardBody>
                                                <Elements stripe={stripePromise}>
                                                    <InjectedCheckoutForm cartItems={props.cartItems}
                                                                          cartTotal={props.cartTotal} ideal={false}/>
                                                </Elements>
                                            </CardBody>
                                        </Card>
                                    </Collapse>
