...
function ideal() {
  console.log("ideal is pressed");
  $("#creditcard").prop("checked", false);
  $("#idl").css("display", "block");
  $("#cc").css("display", "none");
  $(".underlineC").css("display", "none");
  $(".underlineI").css("display", "block");
}

function creditcard() {
  console.log("cc is pressed");
  $("#ideal").prop("checked", false);
  $("#idl").css("display", "none");
  $("#cc").css("display", "block");
  $(".underlineI").css("display", "none");
  $(".underlineC").css("display", "block");
}
